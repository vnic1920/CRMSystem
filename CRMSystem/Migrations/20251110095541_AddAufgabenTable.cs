...
{
    /// <inheritdoc />
    public partial class AddAufgabenTable : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ZugewiesenAnUserId = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    ErstelltVonUserId = table.Column<string>(type: "nvarchar(max)", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Aufgaben", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Aufgaben_Kunden_KundeId",
                        column: x => x.KundeId,
